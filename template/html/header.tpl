                ...
                <div class="filter-body clearfix relative">
                    <div class="filter-location">
                        <div class="clearfix">
                            ...
                            <div title="" class="filter-metro filter-location-btn pull-left" style="">
                                <div class="u-arrow"></div>
                                <div class="filter-location-btn-txt">選擇捷運</div>
                            </div>
                            <div title="" class="filter-school filter-location-btn pull-left" style="">
                                <div class="u-arrow"></div>
                                <div class="filter-location-btn-txt">選擇學校</div>
                        </div>
                        <div title="" class="filter-business filter-location-btn pull-left" style="">
                            <div class="u-arrow"></div>
                            <div class="filter-location-btn-txt">選擇商圈</div>
                        </div>
                    </div>
                    <div class="filter-location-list">
                    ...
                    <div class="filter-location-list">
                        <div class="section-list clearfix">
                            ...
                            <div class="section-list-options clearfix">
                                ...
                                <div class="section-list-item"><a href="javascript:;" j-tips-txt="您最多可選擇5個鄉鎮" class="section-list-item-link">前鎮區</a></div><div class="section-list-item"><a href="javascript:;" j-tips-txt="您最多可選擇5個鄉鎮" class="section-list-item-link">仁武區</a></div><div class="section-list-item"><a href="javascript:;" j-tips-txt="您最多可選擇5個鄉鎮" class="section-list-item-link">大寮區</a></div>
...
應買
</div></div></div> <div class="filter-isclinch filter-more pull-left" style="width: 100px;"><div class="u-arrow"></div> <div title="" class="filter-more-txt">
点交情况
</div> <div class="filter-more-list"><div data-gtm-stat="中古屋列表頁_更多_点交情况" class="filter-more-item">
點交
</div><div data-gtm-stat="中古屋列表頁_更多_点交情况" class="filter-more-item">
不點交
</div><div data-gtm-stat="中古屋列表頁_更多_点交情况" class="filter-more-item">
部分點交
</div></div></div> <div class="filter-houseage filter-more pull-left" style="width: 90px;"><div class="u-arrow"></div> <div title="" class="filter-more-txt">
屋齡
...
樓層
</div> <div class="filter-more-list" ><div data-gtm-stat="中古屋列表頁_更多_樓層" class="filter-more-item">
1層
</div><div data-gtm-stat="中古屋列表頁_更多_樓層" class="filter-more-item">
2-6層
</div><div data-gtm-stat="中古屋列表頁_更多_樓層" class="filter-more-item">
6-12層
</div><div data-gtm-stat="中古屋列表頁_更多_樓層" class="filter-more-item">
...
生活機能
</div> <div class="filter-more-list" ><div data-gtm-stat="中古屋列表頁_更多_生活機能" class="filter-more-item">
便利店
...
百貨公司
</div></div></div> <div class="filter-role filter-more pull-left" style="width: 110px;"><div class="u-arrow"></div> <div title="" class="filter-more-txt">
經辦人選擇
</div> <div class="filter-more-list" ><div data-gtm-stat="中古屋列表頁_更多_經辦人選擇" class="filter-more-item">
屋主刊登
</div><div data-gtm-stat="中古屋列表頁_更多_經辦人選擇" class="filter-more-item">
仲介刊登
</div><div data-gtm-stat="中古屋列表頁_更多_經辦人選擇" class="filter-more-item">
代理人刊登
