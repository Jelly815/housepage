<div class="header">
    ...
    <div id="featured">
        ...
        2.系統會收集您的操作(停留時間、滑過/選取文字 項目代表在意的項目)。<br>
        3.喜歡的房子，可以加入最愛。<br>
        4.若無加入最愛，系統將以瀏覽次數超過1次，判為是您喜歡的房屋。(可以重整)<br>
        5.若有加入最愛的動作，4.即使瀏覽多次或是只有瀏覽1次，系統都將以加入最愛的房屋為主。<br>
        6.若您的瀏覽習慣，無加入最愛/滑過項目/選取文字，可不用。<br>
        7.目的為建立(收集)資料。
                        </p>
                    </div>
                </li>
        ...
        3.角色1：有 加入最愛 的習慣。角色2：有 滑過/選取文字 的習慣。<br>
         &nbsp;&nbsp;&nbsp;角色3：以上兩種習慣皆無。角色4：以上兩種習慣都有。<br>
        4.瀏覽次數超過1次，判為是您喜歡的房屋。(可以重整)。<br>
        5.系統會收集您的操作習慣。<br>
        6.目的為建立(收集)資料。
                        </p>
                    </div>
